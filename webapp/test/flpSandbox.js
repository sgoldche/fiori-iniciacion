		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#Logalicourseorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Logalicourseorders-display": {
								"semanticObject": "Logalicourseorders",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Logalicourse.orders",
									"url": sap.ui.require.toUrl("Logalicourse/orders")
								}
							}
						}
					}
